    ...
    return (
        <div className='mt-32 text-center grid lg:grid-cl' data-aos="fade-up">
            ...
            {loading ? (<div role="status">
                <svg aria-hidden="true" className="mx-auto mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
