    ...
    return (
        <div className='w-10/12 mx-auto mt-32 text-center' data-aos="fade-up">
            ...
            {loading ? <div class="text-center">
                <div role="status">
                    <svg class="inline my-32 mr-2 w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
